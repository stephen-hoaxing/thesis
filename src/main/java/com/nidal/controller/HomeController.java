...
public class HomeController {
    ...
    public ModelAndView getNavigationDetails(@RequestParam("start") String start, @RequestParam("end") String end) {
        ...
        Iterable<Map<String, List<Map<String, Object>>>> p = roomService.getShortestPath(Long.parseLong(start), Long.parseLong(end));
        ...
        for (Map<String, List<Map<String, Object>>> act : p) {
            for (Map.Entry<String, List<Map<String, Object>>> entry : act.entrySet()) {
                String key = entry.getKey();
